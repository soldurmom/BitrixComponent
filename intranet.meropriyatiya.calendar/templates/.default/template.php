...
$TYPE_BGCOLORS = array();
$TYPES = array();
$property_enums = CIBlockPropertyEnum::GetList(Array("DEF"=>"DESC", "SORT"=>"ASC"), Array("IBLOCK_ID"=>$arParams['IBLOCK_ID'], "CODE"=>"MEET_LIST"));
...
jsBXAC.Init(
	{
		'LOADER': '/bitrix/components/bitrix/intranet.meropriyatiya.calendar/ajax.php',
